#include "myvk/DeviceCreateInfo.hpp"
...
namespace myvk {
void DeviceCreateInfo::Initialize(const Ptr<PhysicalDevice> &physical_device,
...
void DeviceCreateInfo::fetch_queues(const Ptr<Device> &device) const {
