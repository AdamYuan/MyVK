...
public:
	...
	VkBufferMemoryBarrier2 GetMemoryBarrier2(VkPipelineStageFlags2 src_stage_mask, VkPipelineStageFlags2 dst_stage_mask,
	                                         VkAccessFlags2 src_access_mask, VkAccessFlags2 dst_access_mask,
	                                         uint32_t src_queue_family = VK_QUEUE_FAMILY_IGNORED,
	                                         uint32_t dst_queue_family = VK_QUEUE_FAMILY_IGNORED) const {
		return GetMemoryBarrier2(GetSubresourceRange(), src_stage_mask, dst_stage_mask, src_access_mask,
